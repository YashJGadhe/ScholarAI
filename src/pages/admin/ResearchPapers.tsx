/* Admin Research Papers — View research papers for ANY faculty member.
   Admin can select any faculty from dropdown and view their complete paper list.
            ...
            {loading ? (
              ...
              <div className="p-10 text-center text-ink-400">
                {papers && papers.length > 0
                  ...
                  : "No papers found for this faculty member"}
              </div>
            ) : (
